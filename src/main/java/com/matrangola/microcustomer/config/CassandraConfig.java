...
@Configuration
@EnableReactiveCassandraRepositories(basePackages = "com.matrangola.microcustomer.data.repository")
public class CassandraConfig extends AbstractCassandraConfiguration {
    ...
    public String[] getEntityBasePackages() {
        return new String[] { "com.matrangola.microcustomer.data.model" };
    }
}